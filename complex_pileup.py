...
def edit_distance_matrix(ref, donor):
    ...
    print("edit:", output_matrix)
    current_row, current_column = np.unravel_index(output_matrix.argmax(), output_matrix.shape)
